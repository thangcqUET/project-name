...
#define CS_PIN (10)     // Chip Select - ESP32-C3 default SPI CS
#define BUSY_PIN (4)    // Busy status - có thể thay đổi  
#define RES_PIN (21)    // Reset - có thể thay đổi (nếu có GPIO21)
#define DC_PIN (2)      // Data/Command - có thể thay đổi

// SPI pins cho ESP32-C3 (hardware SPI):
// SCK  -> GPIO6  (hardware SPI clock)
// MOSI -> GPIO7  (hardware SPI data)
